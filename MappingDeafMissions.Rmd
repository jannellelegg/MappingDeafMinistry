...
Though the Protestant Episcopal Ministry to the deaf is acknowledged for its widespread influence, the scale of this work is best understood spatially. Geographical data, as well as information about services and clergy, was gathered from diocesan reports, parish records, missionary reports, and newspaper articles in an effort to locate the spaces in which deaf people gathered together.^[Should I add a list of the many, many, sources used here?]  
...
```{r, layout="l-body-outset", fig.width=15, fig.height=6, echo= FALSE, fig.cap= "Map of Mission Sites and Railway Routes, 1870-1880. View sites of signed services and train routes by selecting and deselecting map layers in the legend. Click on red circles for information about service sites."}
